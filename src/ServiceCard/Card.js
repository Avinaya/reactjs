  ...
  return (
    <section>
      ...
      <div className="services">
        <div className="service-1">
          ...
          <div className="description">
            ...
            <p>
            We provide end-to-end web application 
            development services that are strong, scalable and world-class.
            </p>
          </div>
          <div className="shapes">
        ...
        <div className="description">
          ...
          <p>
          Add mobile capabilities and reap the benefits of a connected infrastructure and platform.
          </p>
        </div>
        <div className="shapes">
          <div className="shapes-4"></div>
      ...
      <div className="description">
        ...
        <p>
        Let our intuitive designs add a bit of glam, elegance 
          and ease to your products to compete the mearket. 
